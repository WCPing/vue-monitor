 ...
 */
import type { IDeviceInformation, IMetrics, IReportHandler } from '../types'
import { isNavigatorSupported, isPerformanceSupported } from '../utils/isSupported'
import { convertToMB } from '../utils'
import { metricsName } from '../constants'
import type metricsStore from '../lib/store'

function getDeviceInfo(): IDeviceInformation | undefined {
 ...
 */
export function initDeviceInfo(store: metricsStore, report: IReportHandler, immediately = true): void {
