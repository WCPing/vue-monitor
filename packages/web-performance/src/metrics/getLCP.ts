...
function getLCP(lcp: any): PerformanceObserver | undefined {
 ...
 */
export function initLCP(store: metricsStore, report: IReportHandler, immediately = true, scoreConfig: IScoreConfig): void {
