 ...
 */
import type { IMetrics, INetworkInformation, IReportHandler } from '../types'
import { isNavigatorSupported } from '../utils/isSupported'
import { metricsName } from '../constants'
import type metricsStore from '../lib/store'

function getNetworkInfo(): INetworkInformation | undefined {
 ...
 */
export function initNetworkInfo(store: metricsStore, report: IReportHandler, immediately = true): void {
